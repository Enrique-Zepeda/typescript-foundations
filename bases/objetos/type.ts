(() => {
  // `type` es una palabra reservada de TypeScript que permite crear alias de tipos. Se usa para describir la estructura que debe tener un valor, por ejemplo un objeto.
